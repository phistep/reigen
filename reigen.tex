...
\usepackage[modulo]{lineno} % line numbers
\usepackage{csquotes}
\usepackage{siunitx}
...
\lowertitleback{%
	...
	Geschrieben 1897, Erstausgabe 1900, Uraufführung am 23.12.1920.\\
	Bearbeitung durch Philipp Stephan und Paul Breitner.\\
	\vspace{0.5\baselineskip}
...
\begin{play}
	...
	\gatte
	Nein. Ich bin zu müde. Und außerdem \ldots{}
	...
	\gatte
	\direction{setzt sich zu ihr aufs Bett.} Lies heute nicht mehr. Du wirst dir die Augen verderben.
	...
	\gatte
	Weil die Ehe sonst etwas Unvollkommenes wäre. Sie würde \ldots{} wie soll ich nur sagen \ldots{} sie würde ihre Heiligkeit verlieren.
	...
	\gatte
	Die Sache ist einfach die: wir haben vielleicht schon zehn oder zwölf Liebschaften miteinander gehabt \ldots{} Kommt es dir nicht auch so vor?
	...
	\gatte
	\direction{hat sich auch zu Bett begeben.} Für einen Mann, der sich ein bißchen in der Welt umgesehen hat --- geh, leg den Kopf an meine Schulter --- der sich in der Welt umgesehen hat, bedeutet die Ehe eigentlich etwas viel Geheimnisvolleres als für euch junge Mädchen aus guter Familie. Ihr tretet uns rein und \ldots{} wenigstens bis zu einem gewissen Grad unwissend entgegen, und darum habt ihr eigentlich einen viel klareren Blick für das Wesen der Liebe als wir.
	...
	\gatte
	\direction{küßt sie auf die Stirn.} Sei froh, mein Kind, daß du nie einen Einblick in diese Verhältnisse erhalten hast. Es sind übrigens meist recht bedauernswerte Wesen --- werfen wir keinen Stein auf sie.

	\frau
	Bitt dich --- dieses Mitleid. --- Das kommt mir da gar nicht recht angebracht vor.

	\gatte
	\direction{mit schöner Milde.} Sie verdienen es. Ihr, die ihr junge Mädchen aus guter Familie wart, die ruhig unter Obhut euerer Eltern auf den Ehrenmann warten konntet, der euch zur Ehe begehrt; --- ihr kennt ja das Elend nicht, das die meisten von diesen armen Geschöpfen der Sünde in die Arme treibt.
	...
	\frau
	Freilich, Karl, freilich. Ich habs ja auch nur so gesagt. Geh, erzähl weiter. Es ist so nett, wenn du so redst. Erzähl mir was.
	...
	\frau
	Und doch hast du \ldots{} wer weiß wieviel andere Frauen gerade so in den Armen gehalten wie jetzt mich.

	\gatte
	Sag doch nicht »Frauen«. Frau bist du.

	\frau
	Aber eine Frage mußt du mir beantworten \ldots{} sonst \ldots{} sonst \ldots{} ists nichts mit den Flitterwochen.
	...
	\gatte
	Daß du nie mit einer Frau verkehren wirst, bei der du auch den leisesten Verdacht hast, daß sie \ldots{} kein ganz tadelloses Leben führt.
	...
	\frau
	Also \ldots{} du hast das einmal mitgemacht --- nicht wahr?
...
\scene{Der Gatte und das süsse Mädel.}
...
\begin{play}
	...
	\gatte
	Aber da ist es angenehm warm; was?\direction{ Er hat sich wieder niedergesetzt, umschlingt das süsse Mädel und zieht sie an seine Seite.}
	...
	\gatte
	\direction{küßt sie heftig.} Deine Lippen schmecken nach dem Obersschaum.
	...
	\gatte
	So laß dich doch nicht so lang bitten. Wers gewesen ist, möcht ich wissen.
	...
	\gatte
	\direction{umfängt sie. Langer, heißer Kuß.}
	...
	\gatte
	Herrgott, bist du lieb! \direction{Küßt sie und wird zärtlicher.} Du erinnerst mich auch an wen.
	...
	\suesse
	Nein, das ist aber schon das reine Wunder \ldots{} das ist ja --- nein, die Augen \ldots{} Das G'schau \ldots{} \direction{Schüttelt den Kopf.}
	...
	\gatte
	\direction{küßt sie.} Du hast eigentlich graue Augen, anfangs hab ich gemeint, sie sind schwarz.
	...
	\suesse
	Er war auch schon zweiunddreißig, wie ich ihn kennengelernt hab.
	...
	\suesse
	Was machst denn? \direction{Sie küßt seine Haare.} \ldots{} Du, in dem Wein muß was drin gewesen sein --- so schläfrig \ldots{} du, was g'schieht denn, wenn ich nimmer aufstehn kann? Aber, aber, schau, aber Karl \ldots{} und wenn wer hereinkommt \ldots{} ich bitt dich \ldots{} der Kellner.

	\gatte
	Da \ldots{} kommt sein Lebtag \ldots{} kein Kellner \ldots{} herein \ldots{}
	...
	\gatte
	Ja, glaubst du, ich bin ein \ldots{} ich bin ein Giftmischer?

	\suesse
	Ja, schau, ich verstehs halt nicht. Ich bin doch nicht so \ldots{} Wir kennen uns doch erst seit \ldots{} Du, ich bin nicht so \ldots{} meiner Seel und Gott --- wenn du das von mir glauben tätst ---
	...
	\gatte
	Schließlich, wenn zwei junge Leut allein in einem Zimmer sind, und nachtmahlen und trinken Wein \ldots{} Es braucht gar nichts drin zu sein in dem Wein \ldots{}
	...
	\gatte
	\direction{kommt nach ein paar Sekunden zu ihr.</i> Ihr seid wirklich sonderbare Geschöpfe, ihr \ldots{} Weiber. <i>Er wird wieder zärtlich an ihrer Seite.}
	...
	\gatte
	\direction{umfängt sie heiß.} Das andere besprechen wir im Nachhausfahren. \direction{Steht auf, öffnet die Tür.} Kellner \ldots{} die Rechnung!
